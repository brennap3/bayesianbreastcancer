...
It should be noted that all data are categorical in nature. We will read in the data, set the column names and output the first 5 rows to see the form of the data, we will also the degree.malgnant data attribute to a factor as this is ordinal data not numeric. 
...
From the plot we can see some potentially interesting associations:
 1. There appears to be a strong association between irradiation and recurrence events as opposed
to a strong association with  no irradiation and no-recurrence events
